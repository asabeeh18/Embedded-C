...
int main()
{
	...
	while(1)
	{
		...
		if(Center_white_line<30 && Left_white_line<40 && Right_white_line<30)
		{
			lcd_print (1, 1,3,1);
			//forward();
			velocity(100,100);
				motion_set(0x09);
			while(Center_white_line<30 && Left_white_line<30 && Right_white_line<30)
			{
				lcd_print (1,1,4,1);
				velocity(100,100);
